...
uint256 hashGenesisBlock("0xa5fe5408145ae5f3e0b3aa35251688cd1394caf8bbc1d68f9d07ece6253afd8f");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // TESTCoin: starting difficulty is 1 / 2^12
...
static const int64 nTargetSpacing = 20; // TESTCoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x717d92ac1ef5b3e637397cf94c0f28c1cdab7309ea704ade0de26e86188cb92b");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "wew";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("ccefc68044ce825e9f5de734566b51cc0f30e242e718364c959383f819e84c18ef58766ecfd9501cf9397c2c8155ad97616349d4472abfd9d14fbc95c365261da4") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1542846290;
        block.nBits    = 504365644;
        block.nNonce   = 6062535;

        if (fTestNet)
        {
            block.nTime    = 1542846290;
            block.nNonce   = 2430378602;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x378dd216da8872d88c9ec51741ec90a3d510c212b42cd72ee29c37098bd73c14"));
        block.print();
